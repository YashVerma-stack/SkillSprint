...
export const getCourseProgress = async (req, res) => {
    try {
        ...
        // step-3 return the user'c course progress along with course details
        return res.status(200).json({
            data: {
                courseDetails,
...
export const updateLectureProgress = async (req, res) => {
    try {
        ...
        if (!courseProgress) {
            // step-3  If no progress exist, create a new record
        ...
        // step-3 find the lecture progress in the course progress
